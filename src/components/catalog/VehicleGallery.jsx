...
export default function VehicleGallery({ images = [], alt = '', premium = false }) {
  ...
  if (pics.length === 0) {
    return (
      <div className="grid aspect-[4/3] w-full place-items-center rounded-[24px] bg-gradient-to-br from-[#2a2a30] to-[#0b0b0f]">
  ...
  return (
    <div className="group relative aspect-[4/3] overflow-hidden rounded-[24px] shadow-glass">
