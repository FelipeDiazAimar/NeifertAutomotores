...
begin
  ...
  select
    ...
    v.version, v.patente, v.tipo, v.anio, v.km, v.transmision, v.color,
  ...
  select
    ...
    coalesce(g.form08, false), g.form08_fecha, g.form08_nota,
    coalesce(g.verif_policial, false), g.verif_policial_fecha, g.verif_policial_nota,
    coalesce(g.multas_nac, false), g.multas_nac_fecha, g.multas_nac_nota,
    coalesce(g.dominio_hist, false), g.dominio_hist_fecha, g.dominio_hist_nota,
    coalesce(g.libre_deudas, false), g.libre_deudas_fecha, g.libre_deudas_nota,
    coalesce(g.titulo, false), g.titulo_fecha, g.titulo_nota,
    coalesce(g.cedulas, false), g.cedulas_fecha, g.cedulas_nota,
    coalesce(g.identificacion, false), g.identificacion_fecha, g.identificacion_nota,
    coalesce(g.items_extra, '{}'::jsonb),
